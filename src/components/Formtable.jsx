  ...
  return (
    <div className="addContainer">
            ...
            <div className="close-btn" onClick={handleclose}><MdClose/></div>
              ...
              <input type="email" id="email" name="email" onChange={handleOnChange} value={rest.Bank_name}/>

              <label>Account_no : </label>
              <input type="number" id="mobile" name="mobile" onChange={handleOnChange} value={rest.Account_no}/>
